...
#
Diseño e implementación de un sistema de archivos distribuidos minimalista como un Almacenamiento por Objetos con un servidor NameNode que gestiona la ubicación de los archivos y registra los DataNodes disponibles 
...
1. En la máquina del NFS, se tuvo que colocar la siguiente linea en /etc/exports
        ...
        /var/nfs/shared/confs    172.31.93.189(rw,sync,no_root_squash,no_subtree_check)
        /var/nfs/shared/confs    172.31.87.133(rw,sync,no_root_squash,no_subtree_check)
...
3. Para cada máquina de Drupal se tuvo que realizar el comando:
        ...
        172.31.82.121:/var/nfs/shared/confs    /nfs/shared/confs   nfs auto,nofail,noatime,nolock,intr,tcp,actimeo=1800 0 0
